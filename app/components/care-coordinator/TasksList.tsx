...
import { CheckSquare, UserPlus, CalendarPlus, CalendarClock, Check, Clock3 } from "lucide-react";
...
const TYPE_CONFIG = {
  ...
  "follow-up-booking": { label: "Follow-Up", icon: CalendarClock, color: "bg-violet-100 text-violet-700 dark:bg-violet-950/40 dark:text-violet-400" },
};
