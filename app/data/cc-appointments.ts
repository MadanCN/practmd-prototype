...
const RAW_APPOINTMENTS: CcAppointment[] = [
  ...
  { id: "e04", patientId: "pt10", providerId: "p1", clinicId: "penfield-psychiatry", visitType: "Follow-Up", mode: "in-person", date: d(-1), startTime: "17:00", endTime: "17:30", duration: 30, status: "completed", scheduleType: "appointment", appointmentType: "fixed" },
