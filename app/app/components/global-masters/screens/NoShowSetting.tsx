...
export default function NoShowSettingScreen() {
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-semibold text-slate-900 dark:text-slate-100">No Show Setting</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400">Configure the fee charged for missed appointments.</p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden divide-y divide-slate-100 dark:divide-slate-800">
        ...
        <div className={cn(
          ...
          <div>
            <p className="text-sm font-semibold text-slate-800 dark:text-slate-200">Enable No Show Fee</p>
            <p className="text-xs text-slate-500 dark:text-slate-400">Charge a fee to patients who miss appointments without prior notice</p>
          </div>
        ...
        {enabled && (
          <div className="px-5 py-4 space-y-2">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">
              Fee charged to patients who miss appointments without prior notice.
            </p>
